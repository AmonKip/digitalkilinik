...
namespace ePatientCare.Migrations
{
    ...
    [Migration("20171125222241_UpdatedVisitsModel_AddF_KeyConstraint")]
    partial class UpdatedVisitsModel_AddF_KeyConstraint
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ePatientCare.Models.Visit", b =>
                {
                    b.HasOne("ePatientCare.Models.Patient")
                        .WithMany("Visits")
                        .HasForeignKey("PatientID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ePatientCare.Models.UserDetails")
                        .WithMany("Visits")
